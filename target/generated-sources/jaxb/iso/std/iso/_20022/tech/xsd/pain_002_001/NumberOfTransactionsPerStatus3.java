...
@XmlType(name = "NumberOfTransactionsPerStatus3", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.002.001.03", propOrder = {
    "dtldNbOfTxs",
    "dtldSts",
    "dtldCtrlSum"
})
    ...
    implements Serializable
{
    ...
    @XmlElement(name = "DtldNbOfTxs", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.002.001.03", required = true)
    protected String dtldNbOfTxs;
    @XmlElement(name = "DtldSts", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.002.001.03", required = true)
