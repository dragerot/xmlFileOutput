...
@XmlType(name = "StructuredRemittanceInformation7", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.02", propOrder = {
    "rfrdDocInves",
    "rfrdDocAmt",
    "cdtrRefInf",
    "invcr",
    ...
    implements Serializable
{
    ...
    @XmlElement(name = "RfrdDocInf", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.02")
    protected List<ReferredDocumentInformation3> rfrdDocInves;
    @XmlElement(name = "RfrdDocAmt", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.02")
    protected RemittanceAmount1 rfrdDocAmt;
    @XmlElement(name = "CdtrRefInf", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.02")
    protected CreditorReferenceInformation2 cdtrRefInf;
    @XmlElement(name = "Invcr", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.02")
    protected PartyIdentification32 invcr;
    @XmlElement(name = "Invcee", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.02")
    protected PartyIdentification32 invcee;
    @XmlElement(name = "AddtlRmtInf", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.02")
