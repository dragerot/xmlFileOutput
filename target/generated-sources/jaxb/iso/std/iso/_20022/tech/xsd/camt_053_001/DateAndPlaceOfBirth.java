...
@XmlType(name = "DateAndPlaceOfBirth", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.02", propOrder = {
    "birthDt",
    "prvcOfBirth",
    "cityOfBirth",
    "ctryOfBirth"
    ...
    implements Serializable
{
    ...
    @XmlElement(name = "BirthDt", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.02", required = true)
    protected XMLGregorianCalendar birthDt;
    @XmlElement(name = "PrvcOfBirth", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.02")
    protected String prvcOfBirth;
    @XmlElement(name = "CityOfBirth", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.02", required = true)
    protected String cityOfBirth;
    @XmlElement(name = "CtryOfBirth", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.02", required = true)
