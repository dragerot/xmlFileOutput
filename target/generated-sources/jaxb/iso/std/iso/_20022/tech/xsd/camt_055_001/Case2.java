...
@XmlType(name = "Case2", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.055.001.01", propOrder = {
    "id",
    "cretr",
    "reopCaseIndctn"
})
    ...
    implements Serializable
{
    ...
    protected String id;
    @XmlElement(name = "Cretr", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.055.001.01", required = true)
    protected Party7Choice cretr;
    @XmlElement(name = "ReopCaseIndctn", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.055.001.01")
