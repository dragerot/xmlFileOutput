...
@XmlType(name = "FromToAmountRange", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.02", propOrder = {
    "frAmt",
    "toAmt"
})
    ...
    implements Serializable
{
    ...
    @XmlElement(name = "FrAmt", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.02", required = true)
    protected AmountRangeBoundary1 frAmt;
    @XmlElement(name = "ToAmt", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.02", required = true)
