...
@XmlType(name = "ClearingSystemMemberIdentification2", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.001.001.03", propOrder = {
    "clrSysId",
    "mmbId"
})
    ...
    implements Serializable
{
    ...
    @XmlElement(name = "ClrSysId", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.001.001.03")
    protected ClearingSystemIdentification2Choice clrSysId;
    @XmlElement(name = "MmbId", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.001.001.03", required = true)
