...
@XmlType(name = "DatePeriodDetails", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.02", propOrder = {
    "frDt",
    "toDt"
})
    ...
    implements Serializable
{
    ...
    @XmlElement(name = "FrDt", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.02", required = true)
    protected XMLGregorianCalendar frDt;
    @XmlElement(name = "ToDt", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.02", required = true)
