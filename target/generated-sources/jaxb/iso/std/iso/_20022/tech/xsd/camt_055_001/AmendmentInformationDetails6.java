...
@XmlType(name = "AmendmentInformationDetails6", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.055.001.01", propOrder = {
    "orgnlMndtId",
    "orgnlCdtrSchmeId",
    "orgnlCdtrAgt",
    "orgnlCdtrAgtAcct",
    ...
    implements Serializable
{
    ...
    @XmlElement(name = "OrgnlMndtId", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.055.001.01")
    protected String orgnlMndtId;
    @XmlElement(name = "OrgnlCdtrSchmeId", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.055.001.01")
    protected PartyIdentification32 orgnlCdtrSchmeId;
    @XmlElement(name = "OrgnlCdtrAgt", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.055.001.01")
    protected BranchAndFinancialInstitutionIdentification4 orgnlCdtrAgt;
    @XmlElement(name = "OrgnlCdtrAgtAcct", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.055.001.01")
    protected CashAccount16 orgnlCdtrAgtAcct;
    @XmlElement(name = "OrgnlDbtr", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.055.001.01")
    protected PartyIdentification32 orgnlDbtr;
    @XmlElement(name = "OrgnlDbtrAcct", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.055.001.01")
    protected CashAccount16 orgnlDbtrAcct;
    @XmlElement(name = "OrgnlDbtrAgt", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.055.001.01")
    protected BranchAndFinancialInstitutionIdentification4 orgnlDbtrAgt;
    @XmlElement(name = "OrgnlDbtrAgtAcct", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.055.001.01")
    protected CashAccount16 orgnlDbtrAgtAcct;
    @XmlElement(name = "OrgnlFnlColltnDt", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.055.001.01")
    protected XMLGregorianCalendar orgnlFnlColltnDt;
    @XmlElement(name = "OrgnlFrqcy", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.055.001.01")
