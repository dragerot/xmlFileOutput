...
@XmlType(name = "DatePeriodDetails", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.001.001.03", propOrder = {
    "frDt",
    "toDt"
})
    ...
    implements Serializable
{
    ...
    @XmlElement(name = "FrDt", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.001.001.03", required = true)
    protected XMLGregorianCalendar frDt;
    @XmlElement(name = "ToDt", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.001.001.03", required = true)
