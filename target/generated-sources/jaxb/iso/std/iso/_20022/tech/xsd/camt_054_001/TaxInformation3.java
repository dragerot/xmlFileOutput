...
@XmlType(name = "TaxInformation3", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.02", propOrder = {
    "cdtr",
    "dbtr",
    "admstnZn",
    "refNb",
    ...
    implements Serializable
{
    ...
    @XmlElement(name = "AdmstnZn", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.02")
    protected String admstnZn;
    @XmlElement(name = "RefNb", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.02")
    protected String refNb;
    @XmlElement(name = "Mtd", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.02")
    protected String mtd;
    @XmlElement(name = "TtlTaxblBaseAmt", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.02")
    protected ActiveOrHistoricCurrencyAndAmount ttlTaxblBaseAmt;
    @XmlElement(name = "TtlTaxAmt", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.02")
    ...
    @XmlElement(name = "SeqNb", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.02")
    protected BigDecimal seqNb;
    @XmlElement(name = "Rcrd", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.02")
