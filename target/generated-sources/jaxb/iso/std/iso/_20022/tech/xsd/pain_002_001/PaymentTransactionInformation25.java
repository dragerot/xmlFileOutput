...
@XmlType(name = "PaymentTransactionInformation25", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.002.001.03", propOrder = {
    "stsId",
    "orgnlInstrId",
    "orgnlEndToEndId",
    "txSts",
    ...
    implements Serializable
{
    ...
    @XmlElement(name = "ChrgsInf", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.002.001.03")
    protected List<ChargesInformation5> chrgsInves;
    @XmlElement(name = "AccptncDtTm", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.002.001.03", type = String.class)
    @XmlJavaTypeAdapter(Adapter1 .class)
    protected Calendar accptncDtTm;
    @XmlElement(name = "AcctSvcrRef", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.002.001.03")
    protected String acctSvcrRef;
    @XmlElement(name = "ClrSysRef", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.002.001.03")
    protected String clrSysRef;
    @XmlElement(name = "OrgnlTxRef", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.002.001.03")
    ...
    public List<ChargesInformation5> getChrgsInves() {
        if (chrgsInves == null) {
            chrgsInves = new ArrayList<ChargesInformation5>();
        }
