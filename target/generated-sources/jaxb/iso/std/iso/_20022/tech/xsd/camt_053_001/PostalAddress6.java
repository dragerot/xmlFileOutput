...
@XmlType(name = "PostalAddress6", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.02", propOrder = {
    "adrTp",
    "dept",
    "subDept",
    "strtNm",
    ...
    implements Serializable
{
    ...
    @XmlElement(name = "AdrTp", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.02")
    protected AddressType2Code adrTp;
    @XmlElement(name = "Dept", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.02")
    protected String dept;
    @XmlElement(name = "SubDept", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.02")
    protected String subDept;
    @XmlElement(name = "StrtNm", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.02")
    protected String strtNm;
    @XmlElement(name = "BldgNb", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.02")
    protected String bldgNb;
    @XmlElement(name = "PstCd", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.02")
    protected String pstCd;
    @XmlElement(name = "TwnNm", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.02")
    protected String twnNm;
    @XmlElement(name = "CtrySubDvsn", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.02")
    protected String ctrySubDvsn;
    @XmlElement(name = "Ctry", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.02")
    protected String ctry;
    @XmlElement(name = "AdrLine", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.02")
