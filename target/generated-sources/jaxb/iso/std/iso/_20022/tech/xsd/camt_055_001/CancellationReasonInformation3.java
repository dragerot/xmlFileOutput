...
@XmlType(name = "CancellationReasonInformation3", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.055.001.01", propOrder = {
    "orgtr",
    "rsn",
    "addtlInves"
})
    ...
    implements Serializable
{
    ...
    @XmlElement(name = "Orgtr", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.055.001.01")
