...
@XmlType(name = "ImpliedCurrencyAmountRangeChoice", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.02", propOrder = {
    "neqAmt",
    "eqAmt",
    "frToAmt",
    "toAmt",
    ...
    implements Serializable
{
    ...
    @XmlElement(name = "NEQAmt", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.02")
    protected BigDecimal neqAmt;
    @XmlElement(name = "EQAmt", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.02")
    protected BigDecimal eqAmt;
    @XmlElement(name = "FrToAmt", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.02")
    protected FromToAmountRange frToAmt;
    @XmlElement(name = "ToAmt", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.02")
    protected AmountRangeBoundary1 toAmt;
    @XmlElement(name = "FrAmt", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.02")
