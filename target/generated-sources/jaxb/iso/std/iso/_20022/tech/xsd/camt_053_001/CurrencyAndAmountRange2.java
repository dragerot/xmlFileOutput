...
@XmlType(name = "CurrencyAndAmountRange2", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.02", propOrder = {
    "amt",
    "cdtDbtInd",
    "ccy"
})
    ...
    implements Serializable
{
    ...
    @XmlElement(name = "Ccy", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.02", required = true)
