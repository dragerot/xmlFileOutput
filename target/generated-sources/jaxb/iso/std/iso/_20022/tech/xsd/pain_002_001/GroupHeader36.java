...
@XmlType(name = "GroupHeader36", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.002.001.03", propOrder = {
    "msgId",
    "creDtTm",
    "initgPty",
    "fwdgAgt",
    ...
    implements Serializable
{
    ...
    @XmlElement(name = "MsgId", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.002.001.03", required = true)
    protected String msgId;
    @XmlElement(name = "CreDtTm", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.002.001.03", required = true, type = String.class)
    @XmlJavaTypeAdapter(Adapter1 .class)
    protected Calendar creDtTm;
    @XmlElement(name = "InitgPty", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.002.001.03")
    protected PartyIdentification32 initgPty;
    @XmlElement(name = "FwdgAgt", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.002.001.03")
