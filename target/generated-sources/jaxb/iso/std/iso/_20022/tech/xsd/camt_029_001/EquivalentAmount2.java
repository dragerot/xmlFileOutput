...
@XmlType(name = "EquivalentAmount2", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.029.001.03", propOrder = {
    "amt",
    "ccyOfTrf"
})
    ...
    implements Serializable
{
    ...
    @XmlElement(name = "CcyOfTrf", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.029.001.03", required = true)
