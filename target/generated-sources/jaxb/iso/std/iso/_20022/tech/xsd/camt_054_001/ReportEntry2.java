...
@XmlType(name = "ReportEntry2", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.02", propOrder = {
    "ntryRef",
    "amt",
    "cdtDbtInd",
    "rvslInd",
    ...
    implements Serializable
{
    ...
    @XmlElement(name = "NtryRef", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.02")
    protected String ntryRef;
    @XmlElement(name = "Amt", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.02", required = true)
    protected ActiveOrHistoricCurrencyAndAmount amt;
    @XmlElement(name = "CdtDbtInd", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.02", required = true)
    protected CreditDebitCode cdtDbtInd;
    @XmlElement(name = "RvslInd", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.02")
    protected Boolean rvslInd;
    @XmlElement(name = "Sts", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.02", required = true)
    protected EntryStatus2Code sts;
    @XmlElement(name = "BookgDt", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.02")
    protected DateAndDateTimeChoice bookgDt;
    @XmlElement(name = "ValDt", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.02")
    protected DateAndDateTimeChoice valDt;
    @XmlElement(name = "AcctSvcrRef", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.02")
    ...
    @XmlElement(name = "BkTxCd", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.02", required = true)
    protected BankTransactionCodeStructure4 bkTxCd;
    @XmlElement(name = "ComssnWvrInd", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.02")
    protected Boolean comssnWvrInd;
    @XmlElement(name = "AddtlInfInd", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.02")
    ...
    @XmlElement(name = "TechInptChanl", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.02")
    ...
    @XmlElement(name = "NtryDtls", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.02")
    protected List<EntryDetails1> ntryDtls;
    @XmlElement(name = "AddtlNtryInf", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.02")
