...
@XmlType(name = "TransactionDates2", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.02", propOrder = {
    "accptncDtTm",
    ...
    implements Serializable
{
    ...
    @XmlElement(name = "AccptncDtTm", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.02", type = String.class)
    @XmlJavaTypeAdapter(Adapter1 .class)
    protected Calendar accptncDtTm;
    @XmlElement(name = "TradActvtyCtrctlSttlmDt", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.02")
    protected XMLGregorianCalendar tradActvtyCtrctlSttlmDt;
    @XmlElement(name = "TradDt", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.02")
    protected XMLGregorianCalendar tradDt;
    @XmlElement(name = "IntrBkSttlmDt", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.02")
    protected XMLGregorianCalendar intrBkSttlmDt;
    @XmlElement(name = "StartDt", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.02")
    protected XMLGregorianCalendar startDt;
    @XmlElement(name = "EndDt", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.02")
    protected XMLGregorianCalendar endDt;
    @XmlElement(name = "TxDtTm", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.02", type = String.class)
    @XmlJavaTypeAdapter(Adapter1 .class)
