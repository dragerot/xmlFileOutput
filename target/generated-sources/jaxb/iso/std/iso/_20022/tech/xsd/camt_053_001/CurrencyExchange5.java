...
@XmlType(name = "CurrencyExchange5", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.02", propOrder = {
    "srcCcy",
    "trgtCcy",
    "unitCcy",
    "xchgRate",
    ...
    implements Serializable
{
    ...
    @XmlElement(name = "SrcCcy", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.02", required = true)
    protected String srcCcy;
    @XmlElement(name = "TrgtCcy", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.02")
    protected String trgtCcy;
    @XmlElement(name = "UnitCcy", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.02")
    protected String unitCcy;
    @XmlElement(name = "XchgRate", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.02", required = true)
    protected BigDecimal xchgRate;
    @XmlElement(name = "CtrctId", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.02")
    protected String ctrctId;
    @XmlElement(name = "QtnDt", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.02", type = String.class)
