...
@XmlType(name = "AmendmentInformationDetails6", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.002.001.03", propOrder = {
    "orgnlMndtId",
    "orgnlCdtrSchmeId",
    "orgnlCdtrAgt",
    "orgnlCdtrAgtAcct",
    ...
    implements Serializable
{
    ...
    @XmlElement(name = "OrgnlCdtrAgt", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.002.001.03")
    protected BranchAndFinancialInstitutionIdentification4 orgnlCdtrAgt;
    @XmlElement(name = "OrgnlCdtrAgtAcct", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.002.001.03")
    protected CashAccount16 orgnlCdtrAgtAcct;
    @XmlElement(name = "OrgnlDbtr", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.002.001.03")
    ...
    @XmlElement(name = "OrgnlDbtrAgtAcct", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.002.001.03")
    protected CashAccount16 orgnlDbtrAgtAcct;
    @XmlElement(name = "OrgnlFnlColltnDt", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.002.001.03")
    protected XMLGregorianCalendar orgnlFnlColltnDt;
    @XmlElement(name = "OrgnlFrqcy", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.002.001.03")
