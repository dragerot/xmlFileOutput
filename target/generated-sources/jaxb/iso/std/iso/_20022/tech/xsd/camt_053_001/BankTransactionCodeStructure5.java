...
@XmlType(name = "BankTransactionCodeStructure5", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.02", propOrder = {
    "cd",
    "fmly"
})
    ...
    implements Serializable
{
    ...
    protected String cd;
    @XmlElement(name = "Fmly", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.02", required = true)
