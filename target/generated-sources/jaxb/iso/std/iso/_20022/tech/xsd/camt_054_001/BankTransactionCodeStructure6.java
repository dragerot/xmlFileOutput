...
@XmlType(name = "BankTransactionCodeStructure6", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.02", propOrder = {
    "cd",
    "subFmlyCd"
})
    ...
    implements Serializable
{
    ...
    protected String cd;
    @XmlElement(name = "SubFmlyCd", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.02", required = true)
