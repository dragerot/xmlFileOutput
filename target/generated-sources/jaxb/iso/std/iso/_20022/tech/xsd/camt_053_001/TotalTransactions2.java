...
@XmlType(name = "TotalTransactions2", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.02", propOrder = {
    "ttlNtries",
    "ttlCdtNtries",
    "ttlDbtNtries",
    "ttlNtriesPerBkTxCds"
    ...
    implements Serializable
{
    ...
    @XmlElement(name = "TtlNtries", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.02")
    protected NumberAndSumOfTransactions2 ttlNtries;
    @XmlElement(name = "TtlCdtNtries", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.02")
    protected NumberAndSumOfTransactions1 ttlCdtNtries;
    @XmlElement(name = "TtlDbtNtries", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.02")
    protected NumberAndSumOfTransactions1 ttlDbtNtries;
    @XmlElement(name = "TtlNtriesPerBkTxCd", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.02")
    protected List<TotalsPerBankTransactionCode2> ttlNtriesPerBkTxCds;
    ...
    /**
     * Gets the value of the ttlNtriesPerBkTxCds property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the ttlNtriesPerBkTxCds property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getTtlNtriesPerBkTxCds().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<TotalsPerBankTransactionCode2> getTtlNtriesPerBkTxCds() {
        if (ttlNtriesPerBkTxCds == null) {
            ttlNtriesPerBkTxCds = new ArrayList<TotalsPerBankTransactionCode2>();
        }
        return this.ttlNtriesPerBkTxCds;
    }
