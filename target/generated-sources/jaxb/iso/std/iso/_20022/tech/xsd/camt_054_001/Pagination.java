...
@XmlType(name = "Pagination", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.02", propOrder = {
    "pgNb",
    "lastPgInd"
})
    ...
    implements Serializable
{
    ...
    @XmlElement(name = "PgNb", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.02", required = true)
    protected String pgNb;
    @XmlElement(name = "LastPgInd", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.02")
