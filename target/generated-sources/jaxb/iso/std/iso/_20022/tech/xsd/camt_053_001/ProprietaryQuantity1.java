...
@XmlType(name = "ProprietaryQuantity1", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.02", propOrder = {
    "tp",
    "qty"
})
    ...
    implements Serializable
{
    ...
    protected String tp;
    @XmlElement(name = "Qty", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.02", required = true)
