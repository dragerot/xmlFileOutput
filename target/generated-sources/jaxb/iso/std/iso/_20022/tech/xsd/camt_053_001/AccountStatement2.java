...
@XmlType(name = "AccountStatement2", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.02", propOrder = {
    "id",
    "elctrncSeqNb",
    "lglSeqNb",
    "creDtTm",
    ...
    implements Serializable
{
    ...
    @XmlElement(name = "Id", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.02", required = true)
    protected String id;
    @XmlElement(name = "ElctrncSeqNb", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.02")
    protected BigDecimal elctrncSeqNb;
    @XmlElement(name = "LglSeqNb", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.02")
    protected BigDecimal lglSeqNb;
    @XmlElement(name = "CreDtTm", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.02", required = true, type = String.class)
    ...
    @XmlElement(name = "CpyDplctInd", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.02")
    protected CopyDuplicate1Code cpyDplctInd;
    @XmlElement(name = "RptgSrc", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.02")
    protected ReportingSource1Choice rptgSrc;
    @XmlElement(name = "Acct", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.02", required = true)
    protected CashAccount20 acct;
    @XmlElement(name = "RltdAcct", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.02")
    ...
    @XmlElement(name = "Bal", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.02", required = true)
    protected List<CashBalance3> bals;
    @XmlElement(name = "TxsSummry", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.02")
    protected TotalTransactions2 txsSummry;
    @XmlElement(name = "Ntry", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.02")
    protected List<ReportEntry2> ntries;
    @XmlElement(name = "AddtlStmtInf", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.02")
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the bals property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     ...
     * 
     */
    public List<CashBalance3> getBals() {
        if (bals == null) {
            bals = new ArrayList<CashBalance3>();
        }
        return this.bals;
    }
