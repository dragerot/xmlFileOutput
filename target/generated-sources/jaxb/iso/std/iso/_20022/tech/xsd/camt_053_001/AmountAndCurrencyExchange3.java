...
@XmlType(name = "AmountAndCurrencyExchange3", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.02", propOrder = {
    "instdAmt",
    "txAmt",
    "cntrValAmt",
    "anncdPstngAmt",
    ...
    implements Serializable
{
    ...
    @XmlElement(name = "InstdAmt", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.02")
    protected AmountAndCurrencyExchangeDetails3 instdAmt;
    @XmlElement(name = "TxAmt", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.02")
    protected AmountAndCurrencyExchangeDetails3 txAmt;
    @XmlElement(name = "CntrValAmt", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.02")
    protected AmountAndCurrencyExchangeDetails3 cntrValAmt;
    @XmlElement(name = "AnncdPstngAmt", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.02")
    protected AmountAndCurrencyExchangeDetails3 anncdPstngAmt;
    @XmlElement(name = "PrtryAmt", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.02")
    protected List<AmountAndCurrencyExchangeDetails4> prtryAmts;
    ...
    /**
     * Gets the value of the prtryAmts property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the prtryAmts property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getPrtryAmts().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<AmountAndCurrencyExchangeDetails4> getPrtryAmts() {
        if (prtryAmts == null) {
            prtryAmts = new ArrayList<AmountAndCurrencyExchangeDetails4>();
        }
        return this.prtryAmts;
    }
