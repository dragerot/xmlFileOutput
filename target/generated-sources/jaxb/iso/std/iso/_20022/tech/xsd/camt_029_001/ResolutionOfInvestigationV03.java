...
@XmlType(name = "ResolutionOfInvestigationV03", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.029.001.03", propOrder = {
    "assgnmt",
    "rslvdCase",
    "sts",
    "cxlDtls",
    ...
    implements Serializable
{
    ...
    @XmlElement(name = "Assgnmt", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.029.001.03", required = true)
    ...
    @XmlElement(name = "Sts", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.029.001.03", required = true)
    protected InvestigationStatus2Choice sts;
    @XmlElement(name = "CxlDtls", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.029.001.03")
    protected List<UnderlyingTransaction3> cxlDtls;
    @XmlElement(name = "StmtDtls", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.029.001.03")
    protected StatementResolutionEntry1 stmtDtls;
    @XmlElement(name = "CrrctnTx", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.029.001.03")
