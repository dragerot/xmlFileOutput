...
@XmlType(name = "CorrectiveInterbankTransaction1", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.029.001.03", propOrder = {
    "grpHdr",
    "instrId",
    "endToEndId",
    "txId",
    ...
    implements Serializable
{
    ...
    @XmlElement(name = "TxId", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.029.001.03")
    protected String txId;
    @XmlElement(name = "IntrBkSttlmAmt", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.029.001.03", required = true)
    protected ActiveOrHistoricCurrencyAndAmount intrBkSttlmAmt;
    @XmlElement(name = "IntrBkSttlmDt", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.029.001.03", required = true)
