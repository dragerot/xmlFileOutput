...
@XmlType(name = "RemittanceLocation2", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.001.001.03", propOrder = {
    "rmtId",
    "rmtLctnMtd",
    "rmtLctnElctrncAdr",
    "rmtLctnPstlAdr"
    ...
    implements Serializable
{
    ...
    @XmlElement(name = "RmtId", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.001.001.03")
    protected String rmtId;
    @XmlElement(name = "RmtLctnMtd", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.001.001.03")
    protected RemittanceLocationMethod2Code rmtLctnMtd;
    @XmlElement(name = "RmtLctnElctrncAdr", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.001.001.03")
    protected String rmtLctnElctrncAdr;
    @XmlElement(name = "RmtLctnPstlAdr", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.001.001.03")
